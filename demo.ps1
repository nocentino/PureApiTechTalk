...
# Give me a invoke-restmethod to get the version of the API
Invoke-RestMethod -Uri "https://sn1-x90r2-f06-33.puretec.purestorage.com/api/api_version" -Credential $Credential -Method GET -ContentType "application/json" -skipCertificateCheck -Verbose
